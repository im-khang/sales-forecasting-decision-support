...
REQUIRED = ['README.md', 'LICENSE', '.gitignore', 'requirements.txt', 'data/raw/.gitkeep', 'data/interim/.gitkeep', 'data/processed/.gitkeep', 'docs', 'reports', 'references', 'dashboard', 'data/raw/real_world_sales_data.csv', 'references/Application-of-PyCaret-AutoML-for-Sales-Forecasting.pdf', 'reports/CASE_RESULT.md', 'data/README.md']


def fail(msg: str) -> int:
    print(f"verify_failed project=sales-forecasting-decision-support reason={msg}")
    return 1
...
def main() -> int:
    ...
    if "sales-forecasting-decision-support" == "olist-delivery-sla-risk-analytics":
    ...
    print("verify_ok project=sales-forecasting-decision-support")
    return 0
